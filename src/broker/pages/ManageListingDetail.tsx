...
/** Tropical pool / property hero — matches preview-style listing imagery */
const thumbnails = [
  'https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?w=800&h=480&fit=crop',
  'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&h=480&fit=crop',
  ...
  return (
    <div className="h-screen max-h-[100dvh] flex overflow-hidden min-w-0" style={{ backgroundColor: tokens.pageBg }}>
      ...
      <div className="flex-1 flex flex-col lg:ml-64 min-w-0 w-full bg-white">
        ...
        <main className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-[max(2.5rem,env(safe-area-inset-bottom,0px))] bg-white" style={{ backgroundColor: tokens.pageBg }}>
          <div className="w-full">
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-none overflow-hidden mb-4">
              ...
              <div className="flex gap-3 p-3 sm:p-4 overflow-x-auto">
                {thumbnails.map((img, idx) => (
                  ...
                  >
                    <img src={img} alt="" className="w-[150px] h-[76px] sm:h-[84px] object-cover" />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
              <div className="lg:col-span-8 space-y-4">
                <div className="bg-white border border-[#E5E7EB] rounded-none p-4 sm:p-5">
                  <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        className="px-2.5 py-1 rounded-full text-[10px] font-normal"
                        style={{ ...font, backgroundColor: '#F5EFE6', color: '#5D4E37' }}
                      >
                        MLS
                      </span>
                    </div>
                  ...
                  <h2 className="text-[28px] sm:text-[36px] leading-[1.1] font-normal text-[#111827] mb-2" style={font}>
                  ...
                  <div className="text-[32px] sm:text-[40px] leading-[1] font-normal text-[#22C55E]" style={font}>
                    $ 450,000
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-3 mt-6 pt-5 border-t border-[#E5E7EB]">
                    <div className="text-center" style={font}>
                      ...
                      <div className="text-[24px] sm:text-[28px] text-[#111827] leading-none">2</div>
                    ...
                    <div className="text-center" style={font}>
                      ...
                      <div className="text-[24px] sm:text-[28px] text-[#111827] leading-none">1200</div>
                      <div className="text-[11px] text-gray-500 mt-2">Sq ft</div>
                    </div>
                    <div className="text-center" style={font}>
                      <MapPin className="w-4 h-4 mx-auto mb-2 text-gray-400" />
                      <div className="text-[24px] sm:text-[28px] text-[#111827] leading-none">2020</div>
                ...
                <div className="bg-white border border-[#E5E7EB] rounded-none p-4 sm:p-5">
                  <h3 className="text-[22px] sm:text-[28px] font-normal text-[#111827] mb-3" style={font}>
                    Property Description
                  </h3>
                  <p className="text-[13px] leading-relaxed text-[#4B5563]" style={font}>
                    Beautiful modern apartment in the heart of downtown Manhattan. This stunning 2-bedroom, 2-bathroom unit
                    features high ceilings, floor-to-ceiling windows with breathtaking city views, and top-of-the-line finishes
                    throughout. The open-concept living and dining area is perfect for entertaining, while the gourmet kitchen
                    boasts stainless steel appliances and granite countertops. Building amenities include 24/7 concierge,
                    fitness center, rooftop terrace, and more.
                  </p>
                </div>

                <div className="bg-white border border-[#E5E7EB] rounded-none p-4 sm:p-5">
                  <h3 className="text-[22px] sm:text-[28px] font-normal text-[#111827] mb-4" style={font}>
                    Features & Amenities
                  </h3>
                  ...
                  <div className="space-y-0 border border-[#E5E7EB] border-x-0">
                    <div className="grid grid-cols-2 py-3 text-[13px]" style={font}>
                      ...
                      <div className="flex justify-between pl-6">
                        <span className="text-[#6B7280]">Year Built</span>
                        <span>2020</span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 py-3 border-t border-[#E5E7EB] text-[13px]" style={font}>
                      ...
                      <div className="flex justify-between pl-6">
                        <span className="text-[#6B7280]">Days on Market</span>
                        <span>15 days</span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 py-3 border-t border-[#E5E7EB] text-[13px]" style={font}>
              ...
              <div className="lg:col-span-4">
                <div className="bg-white border border-[#E5E7EB] rounded-none p-4 sm:p-5">
                  <h3 className="text-[20px] sm:text-[24px] font-normal text-[#111827] mb-4" style={font}>
                    Contact Agent
                  </h3>
                  ...
                  <div className="space-y-3">
                    <div
                      className="w-full flex items-center gap-3 px-4 py-3 border border-[#E5E7EB] rounded-md text-[13px] text-gray-800 bg-white"
                      style={font}
                    >
